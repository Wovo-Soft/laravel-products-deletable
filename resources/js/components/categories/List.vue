...
<script>
    ...
    export default {
        ...
        props: {
            ...
            api_url: {
                type: String,
                default: "/backend/LaravelProducts/categories/list"
            },
            trash_url: {
                type: String,
                default: "/backend/LaravelProducts/categories/delete"
            },
            submit_url: {
                type: String,
                default: "/backend/LaravelProducts/categories/store"
            },
            add_modal_title: {
                type: String,
                default: 'Add / Edit Category'
            },
            view_modal_title: {
                type: String,
