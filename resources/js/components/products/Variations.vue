            ...
            <template v-slot:table>
                ...
                >
                    <template v-slot:cell(image)="row">
                        <b-img-lazy style="max-height: 50px;" :src="row.item.image"></b-img-lazy>
                    </template>
                    ...
                    <b-table small bordered hover striped
                        ...
                        <template v-slot:cell(value)="row">
                            ...
                            <template
                                ...
                                <b-table-lite v-if="row.item.value.length" small bordered head-variant="secondary"
                                              :items="row.item.value" :fields="['id','key','value']"></b-table-lite>
